              ...
              ======================================== */}
                    ...
                    >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex-1 relative z-10 rounded-2xl overflow-hidden bg-[#0A1118]/60 min-h-[250px] md:min-h-[280px] group/insta block shadow-[0_0_30px_rgba(236,72,153,0.1)] hover:shadow-[0_0_40px_rgba(236,72,153,0.3)] transition-all duration-500"
                        >
                            {/* Instagram animated border */}
                            <div className="absolute inset-x-0 -bottom-px h-px bg-gradient-to-r from-transparent via-pink-500 to-transparent group-hover/insta:via-purple-500 transition-colors duration-500" />
                            <div className="absolute inset-y-0 -left-px w-px bg-gradient-to-b from-transparent via-pink-500/50 to-transparent opacity-0 group-hover/insta:opacity-100 transition-opacity duration-500 scale-y-0 group-hover/insta:scale-y-100 origin-bottom" />
                            <div className="absolute inset-y-0 -right-px w-px bg-gradient-to-b from-transparent via-purple-500/50 to-transparent opacity-0 group-hover/insta:opacity-100 transition-opacity duration-500 scale-y-0 group-hover/insta:scale-y-100 origin-bottom" />

                            {/* Background Image (Team photo) */}
                            <div className="absolute inset-0 bg-[url('/images/teamfoto.jpeg')] bg-[length:100%_auto] md:bg-cover bg-[position:center_10%] md:bg-center bg-no-repeat opacity-40 group-hover/insta:opacity-60 group-hover/insta:scale-110 transition-all duration-1000 ease-out" />

                            {/* Gradient Overlay */}
                            <div className="absolute inset-0 bg-gradient-to-t from-[#0A1118] via-[#0A1118]/70 to-transparent group-hover/insta:from-[#0A1118]/90 transition-all duration-700" />

                            {/* Content */}
                            <div className="absolute inset-0 flex flex-col items-center justify-end p-6 md:p-8 text-center pb-8 md:pb-10">
                                {/* IG Story Ring */}
                                <div className="relative mb-4 md:mb-6 group-hover/insta:-translate-y-2 transition-transform duration-500 shrink-0">
                                    <div className="absolute inset-0 bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 rounded-full blur-md opacity-60 group-hover/insta:opacity-100 group-hover/insta:animate-pulse transition-opacity duration-500"></div>
                                    <div className="relative w-16 h-16 md:w-20 md:h-20 shrink-0 rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 p-[3px] group-hover/insta:rotate-[360deg] transition-all duration-1000 ease-in-out shadow-xl shadow-pink-500/30">
                                ...
                                <h4 className="text-xl md:text-2xl font-display font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 via-pink-300 to-purple-300 mb-1 md:mb-2 group-hover/insta:scale-105 transition-transform duration-500">
                                    Folge unserer Reise
                                </h4>
                                <p className="text-xs md:text-sm text-white/80 max-w-[200px] md:max-w-[220px] leading-relaxed group-hover/insta:text-white transition-colors duration-500">
              ...
              ======================================== */}
                    ...
                    >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex-1 relative z-10 rounded-2xl overflow-hidden bg-[#0A1118]/60 min-h-[250px] md:min-h-[280px] group/spotify block shadow-[0_0_30px_rgba(29,185,84,0.1)] hover:shadow-[0_0_40px_rgba(29,185,84,0.25)] transition-all duration-500"
                        >
                            {/* Animated borders */}
                            <div className="absolute inset-x-0 -bottom-px h-px bg-gradient-to-r from-transparent via-[#1DB954] to-transparent group-hover/spotify:via-emerald-400 transition-colors duration-500" />
                            <div className="absolute inset-y-0 -left-px w-px bg-gradient-to-b from-transparent via-[#1DB954]/50 to-transparent opacity-0 group-hover/spotify:opacity-100 transition-opacity duration-500 scale-y-0 group-hover/spotify:scale-y-100 origin-bottom" />
                            <div className="absolute inset-y-0 -right-px w-px bg-gradient-to-b from-transparent via-emerald-400/50 to-transparent opacity-0 group-hover/spotify:opacity-100 transition-opacity duration-500 scale-y-0 group-hover/spotify:scale-y-100 origin-bottom" />

                            {/* Background Elements */}
                            <div className="absolute inset-0 bg-gradient-to-br from-[#1DB954]/10 via-transparent to-transparent opacity-80 group-hover/spotify:opacity-100 transition-all duration-700" />
                            <div className="absolute -right-24 -top-24 w-64 h-64 bg-[#1DB954]/10 rounded-full blur-[80px] group-hover/spotify:bg-[#1DB954]/20 transition-all duration-700" />
                            <div className="absolute -left-24 -bottom-24 w-64 h-64 bg-emerald-500/10 rounded-full blur-[80px] group-hover/spotify:bg-emerald-500/20 transition-all duration-700" />
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center p-4 md:p-6 text-center">
                                ...
                                <div className="relative mb-4 md:mb-8 group-hover/spotify:-translate-y-2 transition-transform duration-500">
                                    <div className="absolute inset-0 bg-[#1DB954] rounded-full blur-[25px] opacity-40 group-hover/spotify:opacity-80 transition-opacity duration-700"></div>
                                    <div className="relative w-20 h-20 md:w-24 md:h-24 rounded-full border border-white/10 bg-gradient-to-b from-[#191414] to-black shadow-2xl flex items-center justify-center group-hover/spotify:animate-[spin_4s_linear_infinite] overflow-hidden">
                                        {/* Vinyl grooves */}
                                    ...
                                    <div className="absolute -bottom-4 md:-bottom-6 left-1/2 -translate-x-1/2 flex items-end justify-center gap-[2px] md:gap-[3px] h-3 md:h-4 w-8 md:w-12 opacity-0 group-hover/spotify:opacity-100 transition-opacity duration-300">
                                        <div className="w-[2px] md:w-[3px] bg-[#1DB954] rounded-[1px] group-hover/spotify:animate-[bounce_0.8s_infinite_0s] h-1/2"></div>
                                        <div className="w-[2px] md:w-[3px] bg-[#1DB954] rounded-[1px] group-hover/spotify:animate-[bounce_1.0s_infinite_0.4s] h-full"></div>
                                        <div className="w-[2px] md:w-[3px] bg-[#1DB954] rounded-[1px] group-hover/spotify:animate-[bounce_0.9s_infinite_0.2s] h-3/4"></div>
                                        <div className="w-[2px] md:w-[3px] bg-[#1DB954] rounded-[1px] group-hover/spotify:animate-[bounce_1.1s_infinite_0.5s] h-1/3"></div>
                                        <div className="w-[2px] md:w-[3px] bg-[#1DB954] rounded-[1px] group-hover/spotify:animate-[bounce_0.7s_infinite_0.1s] h-2/3"></div>
                                    </div>
                                </div>
                                <h4 className="text-lg md:text-xl font-display font-bold text-white mb-1 md:mb-2 group-hover/spotify:text-[#1DB954] transition-colors duration-500">
                                    Offizielle Vereinshymnen
                                </h4>
                                <p className="text-xs md:text-sm text-white/70 max-w-[180px] md:max-w-[200px] leading-relaxed group-hover/spotify:text-white/90 transition-colors duration-500">
